        ...
        <div className='pt-[3.4rem] px-[7rem]'>
            <div className='flex justify-around'>
                <div>
                    ...
                    <p className='text-[#6f6f71] text-[1.25rem] tracking-[-0.015rem] leading-[2.5rem] relative bottom-4'>IOT app for Ultraviolette superbike - 2022</p>
                </div>
                <div className='pt-[9.8rem] pl-[4.5rem] w-[42rem]'>
