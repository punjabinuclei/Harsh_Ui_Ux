...
const Execution = () => {
    return (
        <div>
            ...
            <div className='lg:px-[7rem] px-[1.5rem]'>
                <div className=' lg:px-[1rem]' >
                    ...
                    <div className='flex justify-center'>
                        <Image className='rounded-3xl lg:mt-[5rem]' src={final_img2} alt="final_deisgn_1" />
                    </div>
                   
                    <div className='flex justify-center mb-[10rem]'>
                        <Image className='rounded-3xl lg:mt-[5rem]' src={final_img4} alt="final_deisgn_1" />
                    </div>
                </div>
            </div>
        </div>
