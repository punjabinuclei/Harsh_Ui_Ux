        ...
        <div>
            <div className='pt-[6rem] px-[7rem]'>
                ...
                <div>
                    ...
                    <p className='text-[#9BA3A3] w-[60rem] leading-[1.687rem] pt-[1rem]'>App established a clear information architecture that guided users seamlessly through the app's various sections. They ensured that the navigation menus and interactions were intuitive and user-friendly for both trading and AI-based NFT creation.</p>
                    <div className='flex justify-center'>
